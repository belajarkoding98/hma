...
<div id="tambahPengguna" class="modal fade" role="dialog" aria-labelledby="tambahPengguna" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Tambah Pengguna </h5>
            ...
            @endif
            <form id="formCreatePengguna" method="post">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input name="user_fullname" class="form-control" type="text" id="user_fullname"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input name="user_email" class="form-control" type="text" id="user_email"
